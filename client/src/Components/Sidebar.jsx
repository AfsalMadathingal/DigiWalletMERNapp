...
const Sidebar = () => {
  return (
    <aside className="lg:w-64 w-20 bg-gray-600 bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg ml-1 text-white  xs:h-[89%] lg:h-[91%] shadow-lg  fixed mt-4 p-1 ">
