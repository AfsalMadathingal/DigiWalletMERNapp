      ...
      <div className="w-full max-w-md bg-white shadow-md rounded-lg p-6">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center border rounded-lg px-3 py-2 mt-1 bg-gray-50 relative">
            ...
            <input type={showConfirmPassword ? "text" : "password"} className="w-full border-none outline-none bg-transparent ml-3" placeholder="Confirm your Password" />
        ...
        <button className="w-full py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200 btn-grad">Sign Up</button>
        <Link to="/login" className="text-sm text-gray-700 mt-4">Already have an account? <a href="#" className="text-blue-500">Sign In</a></Link>
